<div align="center">
  <br><img src="https://brands.home-assistant.io/tuya/logo.png" alt="Logo" width="256"><br><br>
</div>
...
> [!CAUTION]
> This replaces the core "tuya" integration!
> It may not work correctly or could cause unexpected problems.

<hr>
<div align="center">
  
`» Adds unsupported (Sub)-devices / (Gateway) devices`

`» Adds various missing entities to supported devices`
...
> almost any of the current changes based on **[xtend_tuya](https://github.com/azerty9971/xtend_tuya/)** by [@azerty9971](https://github.com/azerty9971/)
<br>

### More 'tuya' integrations:<br>
- **[ha_tuya-local](https://github.com/Bitte-ein-Git/ha_tuya-local)**
- **[ha_tuyarc](https://github.com/Bitte-ein-Git/ha_tuya-local)**
<br><br>

<hr><details><summary> 💫 • CREDITS </summary>
<p>
